...
export class IncomeComponent {
  ...
  listOfCategory: any[] = ["Salary","Freelancing","Investment","Stocks","Bitcoin","Bank Transfer","Youtube","Other"]
  ...
  submitForm(){
    this.incomeService.postIncome(this.incomeForm.value).subscribe(res=>{
      ...
      this.message.error("Error while posting the income",{nzDuration:5000})
    })
  }
  getAllIncomes(){
